...
export function ComboboxSortRevenue() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          {value
            ? frameworksSortRevenue.find((framework) => framework.value === value)?.label
            : "Sort by"}
      ...
      <PopoverContent className="w-[200px] p-0">
        <Command>
          ...
          <CommandList>
            ...
            <CommandGroup>
              {frameworksSortRevenue.map((framework) => (
                <CommandItem
                  key={framework.value}
